...
def reviewer_node(agent: BaseAgent):
    ...
    return make_node(agent, build, update, use_paper_path=True)
...
def meta_node(agent: BaseAgent):
    ...
    return make_node(agent, meta_reviewer.build_message, update)
...
def area_chair_node(agent: BaseAgent):
    ...
    return make_node(agent, area_chair.build_message, update, round_offset=-1)
...
def author_node(agent: BaseAgent):
    ...
    return make_node(agent, author.build_message, update, use_paper_path=True, round_offset=-1)
