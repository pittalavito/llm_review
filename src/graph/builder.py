...
class GraphBuilder:
    ...
    def build(agents: dict[AgentName, BaseAgent]) -> StateGraph:
        ...
        graph.set_entry_point(AgentName.REVIEWER_1)
        graph.add_edge(AgentName.REVIEWER_1, AgentName.REVIEWER_2)
        graph.add_edge(AgentName.REVIEWER_2, AgentName.REVIEWER_3)
        ...
        graph.add_conditional_edges(
            ...
            {"loop": AgentName.REVIEWER_1, "end": END},
        )
        return graph
